defmodule FortnoxEx do
  ...
  defdelegate create_asset(client, asset_attrs), to: Asset
  defdelegate list_assets(client, query), to: Asset
  defdelegate stream_assets(client, query), to: Asset
  defdelegate get_asset(client, asset_number), to: Asset
  defdelegate update_asset(client, asset_number, asset_attrs), to: Asset
  defdelegate delete_asset(client, asset_number), to: Asset
  ...
  defdelegate create_currency(client, currency_attrs), to: Currency
  defdelegate list_currencys(client, query), to: Currency
  defdelegate stream_currencys(client, query), to: Currency
  defdelegate get_currency(client, currency_number), to: Currency
  defdelegate update_currency(client, currency_number, currency_attrs), to: Currency
  defdelegate delete_currency(client, currency_number), to: Currency
  ...
  defdelegate create_unit(client, unit_attrs), to: Unit
  defdelegate list_units(client, query), to: Unit
  defdelegate stream_units(client, query), to: Unit
  defdelegate get_unit(client, unit_number), to: Unit
  defdelegate update_unit(client, unit_number, unit_attrs), to: Unit
  defdelegate delete_unit(client, unit_number), to: Unit
end
